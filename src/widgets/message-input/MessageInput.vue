            ...
            <div class="flex-1 relative">
                ...
                >
                    <div
                        ...
                        :class="{
                            'bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 font-semibold': isAtLimit,
                            'bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400':
                                isNearLimit && !isAtLimit,
                            'bg-surface-100 dark:bg-surface-800 text-surface-600 dark:text-surface-400': !isNearLimit
                        }"
                    >
                        {{ charactersRemaining }}
                    </div>
